...
TAccessControlEntity.thrift_spec = (
    ...
    (3, TType.STRING, 'actions', 'UTF8', None, ),  # 3
    (4, TType.STRUCT, 'tableName', [TTableName, None], None, ),  # 4
    (5, TType.STRING, 'nsName', 'UTF8', None, ),  # 5
)
