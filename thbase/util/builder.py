...
class ColumnDescriptorBuilder(object):
	...
	def build(self):
		return TColumnFamilyDescriptor(name=to_bytes(self.name), attributes=self.attributes, configuration=self.configuration,
		                               ...
		                               cacheBloomsOnWrite=self.cacheBloomsOnWrite, cacheDataOnWrite=self.cacheDataOnWrite,
